...
import "../core/BaseAspectEnabledAccount.sol";
...
/**
  ...
  */
contract AspectEnabledSimpleAccount is BaseAspectEnabledAccount, TokenCallbackHandler, UUPSUpgradeable, Initializable {
    ...
    function disApproveAspects(address[] calldata aspectIds) external {
        _requireFromEntryPointOrOwner();
        for (uint256 i = 0; i < aspectIds.length; ++i) {
            _aspectWhitelist[aspectIds[i]] = false;
        }
    }

    /// implement template method of BaseAspectEnabledAccount
    // solhint-disable-next-line no-unused-vars
    function _validateAspectId(UserOperation calldata, address aspectId)
    internal override virtual returns (uint256 validationData) {
